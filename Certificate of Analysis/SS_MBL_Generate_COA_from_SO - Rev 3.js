...
function loading_html()
{
	...
	loadinghtml += "background-image: url(\"http://dev.microbiologics.com/images/MB-Background.jpg\");";
	loadinghtml += "}		<\/style>";
...
function displaycoa(success_lots, missing_lots ,url)
{
	...
	displaycoa += "		<style type=\"text\/css\">";
	displaycoa += "body{";
	displaycoa += "font-family: 'Roboto';";
	displaycoa += "font-size: 14px;";
	displaycoa += "text-align: center;";
	displaycoa += "background-image: url(\"http:\/\/dev.microbiologics.com\/images\/MB-Background.jpg\");";
	displaycoa += "}";
	displaycoa += "div{";
	...
	displaycoa += "	<\/head>";
	displaycoa += "	<body>";
	displaycoa += "		<table align=\"center\" border=\"0\" cellpadding=\"1\" cellspacing=\"1\" style=\"width: 500px; height: 400px\">";
	displaycoa += "			<tbody>";
	displaycoa += "				<tr>";
	displaycoa += "					<td style=\"background-color: rgb(255, 255, 255);\">";
	displaycoa += "						<p>";
	displaycoa += "							<img height=\"75px\" src=\"http:\/\/dev.microbiologics.com\/images\/microbiologicsLogo.jpg\" \/><br \/>";
	displaycoa += "							<b>Certificates of analysis have been generated for the following lot numbers:<\/b><br \/>";
	displaycoa += "							"+parseArray(success_lots_array)+"<\/p>";
	displaycoa += "						<p>";
	displaycoa += "							&nbsp;<\/p>";
	displaycoa += "						<div>";
	displaycoa += "							<a class=\"button-primary-small\" href="+url+">Click here to download the Certificates of Analysis<\/a><\/div>";
	displaycoa += "						<p>";
	displaycoa += "							&nbsp;<\/p>";
	displaycoa += "						<p>";

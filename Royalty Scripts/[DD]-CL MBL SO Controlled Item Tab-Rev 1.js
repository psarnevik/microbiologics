...
function soControllItemsClientPageInit(type, name){
    log('Running Page Init.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
    
	var functionName="soControllItemsClientPageInit";
	//var $LT = ELIM.LIST.wL.LICENSETYPE;
	//GLB_TYPE=type;
	...
	nlapiLogExecution('DEBUG', 'soControllItemsClientPageInit', 'executionContext: ' + executionContext);
...
function soControllItemsClientFieldChange(type, name, linenum){
	log('Running soControllItemsClientFieldChange.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function soControllItemsClientValidateDelete(type, name){
	log('Running soControllItemsClientValidateDelete.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function soControllItemsClientSaveRecord(){
	log('Running soControllItemsClientSaveRecord.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function soControllItemsClientRecalc(type){
	log('Running soControllItemsClientRecalc.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function disableOCIsublistColFields(isDisable){
	log('Running disableOCIsublistColFields.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function loadCountryCodeListArr(recTypeId){
	log('Running loadCountryCodeListArr.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function findCountryCodeIndexInt(countryCodeStr,countryCodeListStrArr){
	log('Running findCountryCodeIndexInt.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function deleteAllControlledItems(){
	log('Running deleteAllControlledItems.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
...
function getOrderControlledItemsFromSoArr(soRec){
	log('Running getOrderControlledItemsFromSoArr.');
    log('Execution Context: '+nlapiGetContext().getExecutionContext());
